...
| :--- | :--- | :--- |
| **Memory & Syntax** | [Terminal Engine](./JAVASCRIPT/basics/app.js)<br>[Syntax Basics](./JAVASCRIPT/basics/script.js)<br>[Variable Scoping](./JAVASCRIPT/basics/brain.js)<br>[Advanced Console Logging](./JAVASCRIPT/BASICS%20-%202/01-console.js)<br>[Variables Intro](./JAVASCRIPT/BASICS%20-%202/02-variables.js)<br>[Console Methods Demo](./JAVASCRIPT/console.js) | Lexical environments, strict `var/let/const` memory allocation, structured console APIs (`table`, `time`, `group`). |
