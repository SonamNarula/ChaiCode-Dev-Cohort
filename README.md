...
- **Functions Drill:** `JAVASCRIPT/ESSENTIALS - 1/functions.js` — declaration vs expression, arrow syntax, template-literal logging, and a default-parameter sum helper. Run with `node "JAVASCRIPT/ESSENTIALS - 1/functions.js"`.
