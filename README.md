...
| :--- | :--- | :--- |
| **Memory & Syntax** | [Terminal Engine](./JAVASCRIPT/basics/app.js)<br>[Syntax Basics](./JAVASCRIPT/basics/script.js)<br>[Variable Scoping](./JAVASCRIPT/basics/brain.js)<br>[Advanced Console Logging](./JAVASCRIPT/BASICS%20-%202/01-console.js)<br>[Variables Intro](./JAVASCRIPT/BASICS%20-%202/02-variables.js) | Lexical environments, strict `var/let/const` memory allocation, structured console APIs (`table`, `time`, `group`). |
| **Data Mechanics** | [Data Types](./JAVASCRIPT/basics/1.html)<br>[Data Types Advanced](./JAVASCRIPT/BASICS%20-%202/03-datatypes.js)<br>[Operator Precedence](./JAVASCRIPT/basics/operator.html) | Primitive vs reference types, `typeof` identification, execution of 11 distinct operator categories (`??`, `?.`, `...`). |
