...
- **Functions Drill:** `JAVASCRIPT/ESSENTIALS - 1/functions.js` — declaration vs expression, arrow syntax, template-literal logging, default-parameter sum helper, return-value demo, greeting callback, and a closure counter factory. Run with `node "JAVASCRIPT/ESSENTIALS - 1/functions.js"`.
