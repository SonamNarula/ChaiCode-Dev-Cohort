...
| **Function Execution** | [Core Functions](./JAVASCRIPT/class2.js)<br>[In-Depth Guide](./JAVASCRIPT/functions_indepth.js) | Arrow functions, closures, IIFEs, lexical scoping, and higher-order callbacks. |
